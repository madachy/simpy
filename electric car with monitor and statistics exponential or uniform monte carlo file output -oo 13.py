...
for iteration in range(num_iterations):
  ...
  for i in range(200):
       ...
       if distribution_type == 'uniform': 
           arrival_time += random.uniform(5, 11)
           charging_time = random.uniform(6, 9)
  ...
  if monte_carlo == True: output_file.write("%2.0f %6.3f %6.3f" % (iteration, car_monitor.mean(), charging_station.actMon.timeAverage()) + '\n')
